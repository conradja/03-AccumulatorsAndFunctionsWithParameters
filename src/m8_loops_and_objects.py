...
def draw_circles1():
    ...
    for p in range(21):
        circle = rg.Circle(rg.Point(200,200), p*10)
...
def draw_circles2():
    ...
    for z in range(18):
        circle = rg.Circle(rg.Point(20*z +50,100), 10)
...
def draw_circles3():
    ...
    for t in range(1,101):
        circle = rg.Circle(rg.Point(200,150), t)
        circle.attach_to(window)
        window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    for d in range(101):
        circle = rg.Circle(rg.Point(200+(80*math.cos(d)), 200 + (80*math.sin(d))), 10)
        circle.attach_to(window)
        window.render()
    window.close_on_mouse_click()
# -----------------------------------------------------------------------------
