...
#         window = rg.RoseWindow(500,300, 'My window')
#
...
#            window = rg.RoseWindow(200, 100, 'my window')
#
...
#        necessary?  Why?
#            It is necessary when you want to close the window when the window finishes drawing. It is necessary at the end of the
           # code after all the other functions have been called or defined.
#
