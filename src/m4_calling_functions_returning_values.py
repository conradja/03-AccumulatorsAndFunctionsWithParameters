...
def run_test_digits_in_cube():
    ...
    #TEST 1
    expected= 9
    result = digits_in_cube(3)
    print('Test 1 expected:', expected)
    print('       actual:', result)

    #TEST 2
    expected = 0
    result = digits_in_cube(0)
    print('Test 2 expected:', expected)
    print('       actual:', result)

    #TEST 3
    expected = 10
    result = digits_in_cube(4)
    print('Test 3 expected:', expected)
    print('       actual:', result)
...
def run_test_digits_in_power():
    ...
    #TEST 1
    expected = 1
    result = digits_in_power(105704, 0)
    print('Test 1 expected:', expected)
    print('       actual:', result)

    #TEST 2
    expected = 13
    result = digits_in_power(5,4)
    print('Test 2 expected:', expected)
    print('       actual:', result)

    #TEST 3
    expected = 8
    result = digits_in_power(2, 3)
    print('Test 3 expected:', expected)
    print('       actual:', result)
...
def run_test_fancy_sums_of_digits():
    ...
    #TEST 1
    expected = 1
    result = fancy_sums_of_digits(10)
    print('TEST 1 expected:', expected)
    print('       actual:', result)

    #TEST 2
    expected = 19084
    result = fancy_sums_of_digits(2)
    print('TEST 2 expected:', expected)
    print('       actual:', result)

    #TEST 3
    expected = 124309
    result = fancy_sums_of_digits(35)
    print('TEST 3 expected:', expected)
    print('       actual:', result)
